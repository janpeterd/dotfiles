#version 100
// Taken from https://github.com/hyprland-community/awesome-hyprland/issues/22
// Modified by GitHub-User JustSimpleKyle and then again by myself
...
vec4 applyScanlines(vec2 tc, vec4 color) {
    // tc.y * SCANLINE_FREQUENCY + time * SCANLINE_SPEED
